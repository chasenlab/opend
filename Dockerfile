...
ARG BUILD_OPEND_VERSION=10.5.6508
ARG OPEND_DIR=/opend
ARG BIN_NAME=OpenD
...
# xxxx_OpenD_10.5.6508_Ubuntu18.04.tar.gz
...
# https://softwaredownload.futustatic.com/moomoo_OpenD_10.5.6508_Ubuntu18.04.tar.gz
